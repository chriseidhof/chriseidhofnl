...
![](/post/view-representable/5.png)

Then, the text setting event is enqueued:

![](/post/view-representable/7.png)
...
![](/post/view-representable/15.png)
