...
struct AboutMe: Rule {
    ...
    @NodeBuilder var aboutMe: Node {
        ...
        I enjoy speaking at conferences. Here's an annotated version of my talk [A Day in the Life of a SwiftUI View](/presentations/day-in-the-life).

        Here's a bio for conferences:

        > Chris is the founder of [objc.io](https://www.objc.io) and creator of [SwiftUI Field Guide](https://www.swiftuifieldguide.com/). He wrote multiple books about Swift, runs the [Swift Talk](https://www.objc.io) video series and organizes SwiftUI workshops.
